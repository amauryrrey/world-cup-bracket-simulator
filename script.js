...
const predefinedScores = {
    ...
    D: { 0: [4, 1], 1: [2, 0], 2: [2, 0], 3: [1, 0], 4: [2, 3], 5:[0, 0] },
    E: { 0: [7, 1], 1: [1, 0], 2: [2, 1], 3: [0, 0], 4: [1, 2], 5:[0, 2] },
    F: { 0: [2, 2], 1: [5, 1], 2: [5, 1], 3: [4, 0], 4: [3, 1], 5:[1, 1] },
    G: { 0: [1, 1], 1: [2, 2], 2: [0, 0], 3: [3, 1], 4: [5, 1], 5:[1, 1] },
    H: { 0: [0, 0], 1: [1, 1], 2: [4, 0], 3: [2, 2], 4: [1, 0], 5:[0, 0] },
    I: { 0: [3, 1], 1: [1, 4], 2: [3, 0], 3: [2, 3], 4: [4, 1], 5:[5, 0] },
    J: { 0: [3, 0], 1: [3, 1], 2: [2, 0], 3: [2, 1], 4: [3, 1], 5:[3, 3]},
    K: { 0: [1, 1], 1: [1, 3], 2: [5, 0], 3: [0, 1], 4: [0, 0], 5:[3, 1] },
    L: { 0: [4, 2], 1: [1, 0], 2: [0, 0], 3: [1, 0], 4: [2, 0], 5:[2, 1] }
};
