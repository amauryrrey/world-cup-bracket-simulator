...
const predefinedScores = {
    ...
    B: { 0: [1, 1], 1: [1, 1], 2: [6, 0], 3: [1, 4] },
    C: { 0: [1, 1], 1: [0, 1], 2: [3, 0], 3: [1, 0] },
    D: { 0: [4, 1], 1: [2, 0], 2: [2, 0], 3: [1, 0] },
    E: { 0: [7, 1], 1: [1, 0], 2: [2, 1], 3: [0, 0] },
    F: { 0: [2, 2], 1: [6, 1], 2: [5, 0], 3: [4, 0] },
    G: { 0: [1, 1], 1: [2, 2], 2: [0, 0], 3: [3, 1] },
    H: { 0: [0, 0], 1: [1, 1], 2: [4, 0], 3: [2, 2] },
    I: { 0: [3, 1], 1: [1, 4], 2: [3, 0], 3: [2, 3] },
    J: { 0: [4, 0], 1: [3, 1], 2: [2, 0], 3: [2, 1] },
    K: { 0: [1, 1], 1: [1, 3] },
    L: { 0: [4, 2], 1: [1, 0] }
};
